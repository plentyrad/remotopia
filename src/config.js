...
exports.DATABASE_URL =
  process.env.DATABASE_URL || 'postgres://localhost:5432/deus'
...
exports.RECAPTCHA_SYSTEM_ONLINE = !!(
...
exports.JOBS_PER_PAGE =
  Number.parseInt(process.env.JOBS_PER_PAGE, 100) || 100
